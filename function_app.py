...
@app.route(route="http_trigger_backup2")
def http_trigger_backup2(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Python HTTP trigger function processed a request.')
    ...
    for input_value in input_values:
        ...
        output_value["data"] = {
            "design_feature": input_value["data"]["image_path"],
            "design_type": "design_type_test",
            "logo": "logo_test",
            "icon": "icon_test",
            "person": "person_test",
            "color": "color_test"
